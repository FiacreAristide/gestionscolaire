                    ...
                    <form method="post" action="" enctype="multipart/form-data">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <select class="form-select" id="pays_residence" name="pays_residence">
                          ...
                          <option {{(old('pays_residence') == 'Afghanistan') ? 'selected' : ''}} value="Albania">Albania</option>
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <input type="radio" id="oui_boursier" name="boursier" value="{{ old('boursier',$getRecord->boursier)}}">
                        <label for="oui_boursier">OUI</label><br>
                        <input type="radio" id="non_boursier" name="boursier" value="{{ old('boursier',$getRecord->boursier)}}">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <input type="radio" id="oui_sal" name="salarie" value="{{ old('boursier',$getRecord->salarie)}}">
                        <label for="oui_sal">OUI</label><br>
                        <input type="radio" id="non_sal" name="salarie" value="{{ old('boursier',$getRecord->salarie)}}" >
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <select id="etatPhys" name="etatPhys" class="form-control">
                          <option value="{{ old('etatPhys',$getRecord->etatPhys)}}etatPhys">En bonne santé</option>
                          <option value="{{ old('etatPhys',$getRecord->etatPhys)}}etatPhys">Maladie légère</option>
                          <option value="{{ old('etatPhys',$getRecord->etatPhys)}}etatPhys">Maladie chronique</option>
                          <option value="{{ old('etatPhys',$getRecord->etatPhys)}}etatPhys">Convalescence</option>
                          <option value="{{ old('etatPhys',$getRecord->etatPhys)}}etatPhys">Autres</option>
                        </select>
                      </div>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                      ...
                                      <select id="matiere" name="matiere" class="form-control" >
                                        ...
                                        <option {{(old('matiere') == $course->id) ? 'selected' : ''}} value="{{ $course->id }}">{{ $course->name }}</option>
                                        @endforeach
                                      </select>
                                      <div style="color: red;"></div>
                                    </div>   
                                    ...
                                    <div class="form-group col-md-6">
                                      ...
                                      <select id="semestre" name="semestre" class="form-control">
                                        ...
                                        <option {{(old('semestre',$getRecord->semestre) == 'semestre1') ? 'selected' : ''}} value="Semestre 1">Semestre 1</option>
                                        <option {{(old('semestre',$getRecord->semestre) == 'semestre2') ? 'selected' : ''}} value="Semestre 2">Semestre 2</option>
                                        <option {{(old('semestre',$getRecord->semestre) == 'semestre3') ? 'selected' : ''}} value="Semestre 3">Semestre 3</option>
                                        <option {{(old('semestre',$getRecord->semestre) == 'semestre4') ? 'selected' : ''}} value="Semestre 4">Semestre 4</option>
                                        <option {{(old('semestre',$getRecord->semestre) == 'semestre5') ? 'selected' : ''}} value="Semestre 5">Semestre 5</option>
                                        <option {{(old('semestre',$getRecord->semestre) == 'semestre6') ? 'selected' : ''}} value="Semestre 6">Semestre 6</option>
                                      </select>  
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                      ...
                                      <p>Voulez-vous changer le mot de passe ? Veuillez ajouter le nouveau mot de passe</p>
                                    </div>
                                  </div>
                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" class="form-control" placeholder="Enter Admission Number" name="admission_number"  value="{{ old('admission_number',$getRecord->admission_number) }}">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" class="form-control" placeholder="Enter Roll Number" name="roll_number"  value="{{ old('roll_number',$getRecord->roll_number) }}">
                        ...
                        <div class="form-group col-md-6">
                          <label>Height</label>
                          <input type="text" class="form-control" placeholder="Your Height" name="height" value="{{ old('height',$getRecord->height) }}">
                        ...
                        <div class="form-group col-md-6">
                          <label>Weight</label>
                          <input type="text" class="form-control" placeholder="Your Weight" name="weight" value="{{ old('weight',$getRecord->weight) }}">
