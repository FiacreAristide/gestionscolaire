                        ...
                        <form action="" method="post" class="submitForm">
                            ...
                            <tr>
                                ...
                                <td style="min-width: 250px;">
                                  ...
                                  <a class="btn btn-primary" target="_blank" href="{{ url('admin/student_result/print?exam_id='.Request::get('exam_id').'&student_id='.$student->user_id)}}">Imprimer</a>
                                </td>
                            </tr>
                        </form>
                        @endforeach
    ...
    <script type="text/javascript">
        $('.submitForm').submit(function(e){
            ...
            $.ajax(
                {
                    type: "POST",
                    url: "{{ url('admin/examinations/submit_register')}}",
                    data: $(this).serialize(),
                    dataType: "json",
        ...
        $('.saveSingleCourse').click(function(e){
            ...
            $.ajax(
                {
                    type : "POST",
                    url : "{{ url('admin/examinations/single_submit_register')}}",
                    data : {
                        "_token": "{{ csrf_token() }}",
                        id: id,
