      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6" style="text-align: right;">
            <a href="{{ url('admin/class_teacher/add') }}" class="btn btn-primary">Ajouter</a>
          </div>
           ...
           <table class="table">
            ...
            <tbody>
             ...
             <tr>
              ...
              <td>
                <a href="{{ url('admin/class_teacher/edit_single/'.$value->id)}}" class="btn btn-primary">Modifier cette ligne uniquement </a>

                <a href="{{ url('admin/class_teacher/edit/'.$value->id)}}" class="btn btn-primary">Modifier toute la classe</a>

                <a href="{{url('admin/class_teacher/delete/'.$value->id)}}" class="btn btn-danger">Supprimer</a>
              </td>
            </tr>
            @endforeach 
          </tbody>
