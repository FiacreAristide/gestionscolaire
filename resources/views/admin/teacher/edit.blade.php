                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="date" class="form-control"  placeholder="" name="date_integration" value="{{ old('date_integration',$getRecord->date_integration) }}">
                        <div style="color: red;"></div>
                      </div> 

                      <div class="form-group col-md-6">
                        <label>Téléphone</label>
                        <input type="tel" class="form-control"  name="telephone" value="" placeholder="99-99-99-99" pattern="(9[0-9]|7[0-9])-[0-9]{2}-[0-9]{2}-[0-9]{2}">
                        <div style="color: red;"></div>
                      </div> 
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" name="adresse"  value="{{ old('adresse',$getRecord->adresse) }}"></textarea>
                        <div style="color: red;"></div>
                      </div>

                      <div class="form-group col-md-6">
                        <label>Dernier diplôme<span style="color:red;">*</span></label>
                        <input type="text" class="form-control" placeholder="Votre dernier diplôme" name="dernier_diplome"  value="{{ old('dernier_diplome',$getRecord->dernier_diplome) }}dernier_diplome">
                        <div style="color: red;"></div>
                      </div>   
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <select class="form-control"  name="grade_universitaire">
                          <option {{(old('grade_universitaire',$getRecord->grade_universitaire) == 'male') ? 'selected' : ''}} value="Non gradé">---Selectionner Grade---</option>
                          <option {{(old('grade_universitaire',$getRecord->grade_universitaire) == 'male') ? 'selected' : ''}} value= "Licence">Licence </option>
                          <option {{(old('grade_universitaire',$getRecord->grade_universitaire) == 'male') ? 'selected' : ''}} value= "Master">Master</option>
                          <option {{(old('grade_universitaire',$getRecord->grade_universitaire) == 'male') ? 'selected' : ''}} value= "Doctorat">Doctorat</option>
                        </select>
                        <div style="color: red;"></div>                        
                      </div>   
