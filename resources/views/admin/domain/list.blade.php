      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6" style="text-align: right;">
            <a href="{{ url('admin/domain/add') }}" class="btn btn-primary">Ajouter un domaine</a>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
              <div class="card-header">
                <h3 class="card-title">Rechercher un domaine </h3>
              </div>
                  ...
                  <tbody>
                    ...
                    @forelse($getRecord as $value)
                      <tr>
                        ...
                        <td>
                        <a href="{{ url('admin/domain/edit/'.$value->id)}}" class="btn btn-primary">Modifier</a>
